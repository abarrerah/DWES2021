...
public class Operations {
	public static ArrayList showAllFirstNameEmployees() throws SQLException, ClassNotFoundException {
    ...
    public static void init() throws SQLException, ClassNotFoundException{
        ...
        System.out.println("1-Show all invoice for a customers."+'\n'+
                ...
                "4-Show all first name from employees"+'\n'+
        ...
        while (k<6){
            switch (k){
                ...
                case 3:getLessMotorBikeSold();
                    break;
                case 4:showAllFirstNameEmployees();
                    break;
